<?php /*a:1:{s:86:"D:\myphp_www\PHPTutorial\WWW\newphp\admins\application\admins\view\cates\index_two.php";i:1547000231;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<body style="padding: 10px;">
	<div class="header">
		...
		<span>二级分类</span>
		<button class="layui-btn layui-btn-sm" onclick="add(<?php echo htmlentities($pid); ?>)">添加</button>
	</div>
	...
	<table class="layui-table">
		...
		<tbody>
			...
			<tr>
				...
				<td><img class="thumb" src="<?php echo htmlentities($vo['img']); ?>" onmouseover="show_img(this)" onmouseleave="hide_img()" style="height: 30px;"></td>
				<td>
					<button class="layui-btn layui-btn-xs" onclick="add(<?php echo htmlentities($pid); ?>,<?php echo htmlentities($vo['id']); ?>)">编辑</button>
